<template>
	<view class="dateView">
		<picker-view v-if="fields=='year'" class="d-picker-view" :indicator-style="itemHeight" :value="pickVal"
			@change="handlerChange">
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.years" :key="index">{{item}}年</view>
			</picker-view-column>
		</picker-view>
		<picker-view v-if="fields=='month'" class="d-picker-view" :indicator-style="itemHeight" :value="pickVal"
			@change="handlerChange">
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.years" :key="index">{{item}}年</view>
			</picker-view-column>
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.months" :key="index">{{item}}月</view>
			</picker-view-column>
		</picker-view>
		<picker-view v-if="fields=='day'" class="d-picker-view" :indicator-style="itemHeight" :value="pickVal"
			@change="handlerChange">
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.years" :key="index">{{item}}年</view>
			</picker-view-column>
			...
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.days" :key="index">{{item}}日</view>
			</picker-view-column>
		</picker-view>
		<picker-view v-if="fields=='hour'" class="d-picker-view" :indicator-style="itemHeight" :value="pickVal"
			@change="handlerChange">
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.years" :key="index">{{item}}年</view>
			</picker-view-column>
			...
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.hours" :key="index">{{item}}时</view>
			</picker-view-column>
		</picker-view>
		<picker-view v-if="fields=='minute'" class="d-picker-view" :indicator-style="itemHeight" :value="pickVal"
			@change="handlerChange">
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.years" :key="index">{{item}}年</view>
			</picker-view-column>
			...
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.minutes" :key="index">{{item}}分</view>
			</picker-view-column>
		</picker-view>
		<picker-view v-if="fields=='second'" class="d-picker-view" :indicator-style="itemHeight" :value="pickVal"
			@change="handlerChange">
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.years" :key="index">{{item}}年</view>
			</picker-view-column>
			...
			<picker-view-column>
				<view class="dateItem" v-for="(item,index) in range.seconds" :key="index">{{item}}秒</view>
			</picker-view-column>
		</picker-view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			resetData(year, month, day, hour, minute) {
				...
				let daysLen = disabledAfter ? ((year * 1 < curYear || month * 1 < curMonth) ? totalDays : curDay) :
					totalDays;
				let hoursLen = disabledAfter ? ((year * 1 < curYear || month * 1 < curMonth || day * 1 < curDay) ? 24 :
					curHour + 1) : 24;
				let minutesLen = disabledAfter ? ((year * 1 < curYear || month * 1 < curMonth || day * 1 < curDay || hour *
					1 < curHour) ? 60 : curMinute + 1) : 60;
				let secondsLen = disabledAfter ? ((year * 1 < curYear || month * 1 < curMonth || day * 1 < curDay || hour *
					1 < curHour || minute * 1 < curMinute) ? 60 : curSecond + 1) : 60;
			...
			getData(dVal) {
				...
				let daysLen = disabledAfter ? ((year < curYear || month < curMonth) ? defaultDate.defaultDays : curDay) : (
					curFlag ? curMonthdays : defaultDate.defaultDays);
				let hoursLen = disabledAfter ? ((year < curYear || month < curMonth || day < curDay) ? 24 : curHour + 1) :
					24;
				let minutesLen = disabledAfter ? ((year < curYear || month < curMonth || day < curDay || hour < curHour) ?
					60 : curMinute + 1) : 60;
				let secondsLen = disabledAfter ? ((year < curYear || month < curMonth || day < curDay || hour < curHour ||
					minute < curMinute) ? 60 : curSecond + 1) : 60;
			...
			initData() {
				...
				let result = "",
					full = "",
					year, month, day, hour, minute, second, obj = {};
				let defaultDate = this.getDefaultDate();
