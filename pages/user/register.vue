	...
	<view class="register">
		...
		<view>
			...
			<view class="input-content">
				...
				<view class="cu-form-group form-group">
					<text class="iconfont icon-invitation from-tit"></text>
					<input placeholder="输入邀请码(选填)" name="input" v-model="invitationCode"></input>
				</view>
				...
				<button class="cu-btn bg-mauve lg confirmBtn" :disabled="confirmBtnDisabled" @click.self.stop="register">注册</button>
			</view>
		</view>
	</view>
</template>
